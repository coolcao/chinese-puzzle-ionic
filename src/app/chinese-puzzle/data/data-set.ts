...
export const levels: Level[] = [
  { id: '横刀立马', name: '横刀立马', difficulty: 'hard', minSteps: 81, pieces: dataSet['横刀立马'] },
  { id: '将拥曹营', name: '将拥曹营', difficulty: 'easy', minSteps: 72, pieces: dataSet['将拥曹营'] },
  { id: '齐头并进', name: '齐头并进', difficulty: 'medium', minSteps: 60, pieces: dataSet['齐头并进'] },
  { id: '指挥若定', name: '指挥若定', difficulty: 'medium', minSteps: 70, pieces: dataSet['指挥若定'] },
  { id: '兵分两路', name: '兵分两路', difficulty: 'hard', minSteps: 72, pieces: dataSet['兵分两路'] },
  { id: '兵临城下', name: '兵临城下', difficulty: 'easy', minSteps: 54, pieces: dataSet['兵临城下'] },
  { id: '一路进军', name: '一路进军', difficulty: 'easy', minSteps: 58, pieces: dataSet['一路进军'] },
  { id: '一路顺风', name: '一路顺风', difficulty: 'easy', minSteps: 39, pieces: dataSet['一路顺风'] },
  { id: '兵临曹营', name: '兵临曹营', difficulty: 'easy', minSteps: 34, pieces: dataSet['兵临曹营'] },
  { id: '雨声淅沥', name: '雨声淅沥', difficulty: 'easy', minSteps: 47, pieces: dataSet['雨声淅沥'] },
  { id: '桃花园中', name: '桃花园中', difficulty: 'easy', minSteps: 70, pieces: dataSet['桃花园中'] },
  { id: '捷足先登', name: '捷足先登', difficulty: 'easy', minSteps: 32, pieces: dataSet['捷足先登'] },
  { id: '围而不歼', name: '围而不歼', difficulty: 'easy', minSteps: 62, pieces: dataSet['围而不歼'] },
  { id: '将守角楼', name: '将守角楼', difficulty: 'easy', minSteps: 100, pieces: dataSet['将守角楼'] },
  { id: '屯兵东路', name: '屯兵东路', difficulty: 'easy', minSteps: 102, pieces: dataSet['屯兵东路'] },
  { id: '凹凸有致', name: '凹凸有致', difficulty: 'easy', minSteps: 134, pieces: dataSet['凹凸有致'] },
